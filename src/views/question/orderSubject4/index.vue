    ...
    <div class="search">
      <el-form :inline="true" :model="searchData">
        ...
        <el-form-item title="">
          <el-space :size="10">
            <div>
              <el-upload class="upload-demo" accept=".xlsx, .xls"
                action="http://111.230.93.133:8083/lid/fourOrderLid/import" :headers="headers" :show-file-list="false"
                @change="uploadError" @progress="uploadProgress" :on-success="uploadSuccess">
...
const submitForm = () => {
  if (title.value === "新增顺序练习") {
    request({
      url: "lid/fourOrderLid/add",
      method: "post",
      data: form.value,
    }).then(({ data }) => {
      ElMessage({
