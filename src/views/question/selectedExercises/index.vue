    ...
    <div class="search">
      <el-form :inline="true" :model="searchData">
        <el-form-item label="车型">
          <el-select v-model="searchData.cartype" class="m-2" clearable style="width: 150px" @change="changeCarType">
        ...
        <el-form-item label="题目类型">
          <el-select style="width: 150px" v-model="searchData.type" class="m-2" placeholder="题目类型" clearable>
            <el-option v-for="(key, val) in selectedTypeList" :key="val" :label="key" :value="val" />
          </el-select>
        </el-form-item>
        <el-form-item title="">
          <el-space :size="10">
          ...
          <el-space :size="10">
            <div>
              <el-upload class="upload-demo" accept=".xlsx, .xls" :action="searchData.cartype == 1
                ? 'http://111.230.93.133:8083/lid/scoreSelectLid/import'
                : searchData.cartype == 2
                  ? 'http://111.230.93.133:8083/lid/mcoreSelectLid/import'
                  : 'http://111.230.93.133:8083/lid/lcoreSelectLid/import'
        ...
        <el-col :span="12">
          <el-form-item label="题目类型" prop="type">
            ...
            <el-select v-model="form.type" placeholder="题目类型" clearable>
              <el-option v-for="(item, val) in selectedTypeList" :key="val" :label="item" :value="val" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
