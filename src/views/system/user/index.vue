  ...
  <div class="app-container">
      ...
      >
        ...
        >
          <template #default="scope">
            <template v-if="nickName == scope.row.nickName">
              <el-switch
        ...
        >
          <template #default="scope">
            <template
              v-if="nickName == scope.row.nickName || nickName == '若依'"
            >
              <el-tooltip
                content="修改"
                placement="top"
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="驾校名称" prop="nickName">
              <el-input
...
const nickName = ref(userData.nickName);
